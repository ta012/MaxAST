...
from audio_model_timm.layers import Conv2dSame, ScaledStdConv2dSame, CondConv2d, StdConv2dSame
from audio_model_timm.layers.non_local_attn import BilinearAttnTransform
from audio_model_timm.layers.pool2d_same import MaxPool2dSame, AvgPool2dSame
...
# NOTE: By default, any modules from audio_model_timm.models.layers that we want to treat as leaf modules go here
# BUT modules from audio_model_timm.models should use the registration mechanism below
_leaf_modules = {
...
try:
    from audio_model_timm.layers import InplaceAbn
